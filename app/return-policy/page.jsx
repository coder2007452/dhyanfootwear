...
export default function ReturnRefundPolicy() {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-700 mb-4">Last updated: August 15, 2025</p>

      <p className="mb-4">Thank you for shopping at Dhyan Footwear.</p>
      ...
      <ul className="list-disc list-inside mb-4 space-y-1">
        <li>
          <strong>Company</strong> refers to Dhyan Footwear.
        </li>
        <li>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Conditions for Returns</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Gifts</h2>
      <p className="mb-4">
